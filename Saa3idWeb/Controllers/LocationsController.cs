...
namespace Saa3idWeb.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CreatedAt,UpdatedAt,Latitude,Longitude,LocationType")] Location location)
        {
		...
		//[ValidateAntiForgeryToken]
		public async Task<IActionResult> CreateAPI([Bind("Id,Title,Description,CreatedAt,UpdatedAt,Latitude,Longitude,LocationType")] Location location)
		{
			return await this.OnCreate(location, (data) => {
				return Json(new
				{
        ...
        [HttpPut]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CreatedAt,UpdatedAt,Latitude,Longitude,LocationType")] Location location)
        {
